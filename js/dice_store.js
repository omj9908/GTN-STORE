const CONTRACT_ADDRESS = "0x2e55fdd5cd72d25ebe307a92524b71dde8205a29";
const ABI = [
	{
		"inputs": [
			{
...
async function checkIfAdmin() {
    try {
        ...
        if (ownerAddress.toLowerCase() === currentAccount.toLowerCase()) {
            ...
            document.getElementById("go-nft-manage-btn").style.display = "none";
        }
    } catch (error) {
